...
import{FlowAttributeChangeEvent,FlowNavigationFinishEvent,FlowNavigationNextEvent,FlowNavigationBackEvent,FlowNavigationPauseEvent} from 'lightning/flowSupport';
export default class RichTextArea extends LightningElement{
@api placeholder;
@api value;
@api required=false;
@api requiredMessage='value is required for this field';
@api label;
